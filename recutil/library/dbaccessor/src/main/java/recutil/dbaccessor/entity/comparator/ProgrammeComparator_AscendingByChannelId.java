...
//        LOG.debug(ReflectionToStringBuilder.toString(o1));
//        LOG.debug(ReflectionToStringBuilder.toString(o2));
        return o1.getChannelId().getChannelId().compareTo(o2.getChannelId().getChannelId());
    }
